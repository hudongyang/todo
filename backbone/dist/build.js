...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppView = __webpack_require__(8),
	    Router = __webpack_require__(9),
	    Todos = __webpack_require__(10),
	    todos = new Todos();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = __webpack_require__(2),
	    ...
	    TodoView = __webpack_require__(12);
	...
	module.exports = Backbone.View.extend({
	    ...
	    renderList: function renderList(filter) {
	        var todoListELe = $('.todo-list').empty(),
	            fragment = document.createDocumentFragment();
	
	        this.getFilters(filter).forEach(function (model) {
	            var ele = new TodoView({
	                model: model
	            }).render().el;
	    ...
	    renderFooter: function renderFooter() {
	        ...
	        this.$el.append(this.footerTmpl({
	    ...
	    checkToggleAll: function checkToggleAll() {
	    ...
	    getFilters: function getFilters(filter) {
	        filter = filter || 'all';
	    ...
	    filter: function filter(_filter) {
	        this.renderList(_filter);
	
	        this.$('.filters li a').removeClass('selected').filter('[href="#/' + _filter + '"]').addClass('selected');
	    },
